...
const dependencyFilename = path.join(__dirname, '8_3_29', 'php_8_3.wasm');
export { dependencyFilename };
export const dependenciesTotalSize = 22796625;
const phpVersionString = '8.3.29';
...
/** not-@type {!BigUint64Array} */ HEAPU64;
	...
	var registerWasmPlugin = () => {
		...
		var wasmPlugin = {
			...
			handle: async (
				byteArray,
				name // loadWebAssemblyModule can not load modules out-of-order, so rather
			) =>
